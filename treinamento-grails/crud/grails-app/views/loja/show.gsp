...
<div id="show-loja" class="content scaffold-show" role="main">
    ...
    %{--<f:display bean="loja"/>--}%
    <f:table collection="${loja.produtos}" />

    <g:form resource="${this.loja}" method="DELETE">
        <fieldset class="buttons">
            <g:link class="edit" action="edit" resource="${this.loja}"><g:message code="default.button.edit.label" default="Edit"/></g:link>
