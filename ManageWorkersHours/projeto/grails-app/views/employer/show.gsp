...
<html>
    ...
    <body>
        ...
        <div id="show-employer" class="content scaffold-show" role="main">
            ...
            <f:display bean="employer" />
            <g:form resource="${this.employer}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.employer}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
